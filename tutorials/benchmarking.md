...
MethodInstance for Main.var\"workspace#4\".double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.var\"workspace#4\" at /home/runner/work/website4/website4/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 990 evaluations.
 Range (min … max):   46.061 ns … 24.322 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      47.172 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   126.434 ns ±  1.024 μs  ┊ GC (mean ± σ):  2.84% ± 1.72%

  ▁▃█▇▆▄▃▁▁▁▂▃▃▂▁              ▁▃▃▃▂▁▁▁                        ▂
  ████████████████▇▆▆▆▄▅▇██▇▇▆▇█████████▇▇▇▆▅▆▅▅▅▅▄▆▅▅▄▄▅▃▁▁▃▄ █
  46.1 ns       Histogram: log(frequency) by time      64.3 ns <
...
BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  24.674 ns …  28.191 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     26.581 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   77.041 ns ± 800.438 ns  ┊ GC (mean ± σ):  3.93% ± 1.72%

   ▅▄▂ ██▆▃▁     ▂▂▁         ▁▁   ▁▄▄▅▅▄▃▃▃▂                   ▂
  ████▇█████▆▅▅▇▇█████▆▄▅▅▃▆███▇▇▇████████████▇▇▆▅▅▆▅▅▃▄▅▅▄▅▃▄ █
  24.7 ns       Histogram: log(frequency) by time      41.3 ns <
